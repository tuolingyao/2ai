    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <div className="rounded-lg border bg-card p-4">
          <p className="text-sm text-muted-foreground">场景总数</p>
          <p className="mt-1 text-3xl font-bold text-foreground">{totalScenes}</p>
        </div>
        <div className="rounded-lg border bg-card p-4">
        ...
        <div className="rounded-lg border bg-card p-4">
          ...
          <p className="mt-1 text-3xl font-bold text-muted-foreground">{draftScenes}</p>
        </div>
        <div className="rounded-lg border bg-card p-4">
          <p className="text-sm text-muted-foreground">学习节点</p>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="rounded-lg border bg-card p-4">
          <p className="text-sm text-muted-foreground">节点完成总数</p>
          <p className="mt-1 text-3xl font-bold text-emerald-600">{completedProgress}</p>
        </div>
        <div className="rounded-lg border bg-card p-4">
          <p className="text-sm text-muted-foreground">活跃用户（7天）</p>
      ...
      <div className="rounded-lg border bg-card overflow-x-auto">
        <div className="border-b px-4 py-3">
          <h2 className="font-semibold text-foreground">最近更新</h2>
        </div>
        {recentScenes.length === 0 ? (
          <p className="p-4 text-sm text-muted-foreground">暂无场景</p>
        ) : (
      ...
      {topFavorites.length > 0 && (
        <div className="rounded-lg border bg-card overflow-x-auto">
          <div className="border-b px-4 py-3">
            <h2 className="font-semibold text-foreground">热门场景</h2>
          </div>
          <table className="w-full text-sm">
            <thead className="border-b bg-muted text-left text-xs text-muted-foreground">
              <tr>
